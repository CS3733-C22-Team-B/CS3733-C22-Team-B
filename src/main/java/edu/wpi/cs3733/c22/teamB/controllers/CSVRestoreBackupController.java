...
public class CSVRestoreBackupController {
    ...
    public void Backup() throws FileNotFoundException {
        ...
        writer.writeAll(
                medicalEquipmentParserI.fromObjectsToStrings(medicalEquipmentDBI.getAllNodes()));
        ...
        writer.writeAll(
                medicineDeliverySRParserI.fromObjectsToStrings(medicineDeliverySRDBI.getAllNodes()));
        ...
        writer.writeAll(
                medicalEquipmentSRParserI.fromObjectsToStrings(medicalEquipmentSRDBI.getAllNodes()));
    }
